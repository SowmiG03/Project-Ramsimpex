...
multiple forms. PHPMailer-FE also has security features to prevent forget_pwd
...
- $useAsAutoResponder is another new feature of PHPMailer-FE (default value is false)
  ...
  to your forget_pwd. If you want to use it purely as an auto-responder and and not send
  ...
  site to receive attachments from your forget_pwd ... this AUTO-RESPONDER capability lets
  you store files on your server to send to your forget_pwd. The way to use that is to put
...
Enjoy!
Andy Prevost
codeworxtech@forget_pwd.sourceforge.net
